...
export default function Footer() {
    ...
    const footerLinks = {
        ...
        app: [
            { label: 'Download For IOS', href: '#download-ios' },
            { label: 'Download For Android', href: '#download-android' },
        ],
        legal: [
    ...
    const socialLinks = [
        ...
        },
        {
            ...
            hoverColor: 'hover:border-pink-600 hover:text-pink-600',
        },
        {
            name: 'LinkedIn',
            ...
            hoverColor: 'hover:border-blue-700 hover:text-blue-700',
        },
    ];

    return (
        <footer className={cn(variants.background.gray, "border-gray-200")}>
            <div className={cn(
                ...
                <div className={cn(
                    ...
                    "gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-10 md:mb-12"
                )}>
                    <div className="lg:max-w-sm">
                        <div className={cn(variants.flex.center, "gap-2 justify-start")}>
                            <Image
                                src="/reppo.png"
                                alt="Reppoo Logo"
                                width={25}
                ...
                <div className={cn(
                    ...
                    "pt-6 sm:pt-8",
                    variants.flex.col,
                    "sm:flex-row justify-between items-center gap-4 sm:gap-6"
                )}>
                    <p className={cn(
                        variants.text.secondary,
                        variants.text.label.sm
                    )}>
                        © Copyright Reppoo {currentYear}
                    </p>
                    ...
                    <div className={cn(
                        ...
                        {socialLinks.map((social) => (
                            <a
                                ...
                                className={cn(
                                    variants.social.button,
                                    social.hoverColor
                                )}
                                aria-label={social.name}
                            >
                                <svg className={variants.social.icon} fill="currentColor" viewBox="0 0 24 24">
                                    {social.icon}
                                </svg>
                            </a>
                        ))}
